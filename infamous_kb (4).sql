...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2023 at 08:57 PM
...
CREATE TABLE `boards` (
  ...
  `board_topic` char(120) NOT NULL,
  `board_moderators` text NOT NULL,
  `board_posts` text NOT NULL,
  `board_msg_id` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'jimmysole', 'Jimmy Sole', 'Rhode Island', '', 'Hi, I\'m Jimmy');
...
--
ALTER TABLE `board_subscriptions`
  ADD CONSTRAINT `board_subscriptions_ibfk_1` FOREIGN KEY (`board_id`) REFERENCES `boards` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
